...
async function seedProductionDatabase() {
  try {
    ...
    const mongoUri = process.env.MONGODB_URI || 'mongodb+srv://username:password@cluster0.xxxxx.mongodb.net/mini-ecommerce?retryWrites=true&w=majority';
    
    if (mongoUri === 'mongodb+srv://username:password@cluster0.xxxxx.mongodb.net/mini-ecommerce?retryWrites=true&w=majority') {
      ...
      console.log('   3. Set it as MONGODB_URI environment variable');
      console.log('   4. Or replace the connection string in this file');
      console.log('   5. Run: node fix-production-data.js');
      process.exit(1);
    }
